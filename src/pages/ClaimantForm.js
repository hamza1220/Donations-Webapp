...
class ClaimantForm extends Component {
  constructor(props) {
	...
	formSubmit = e =>{
		...
		else if (this.state.gender===''){this.setState({error: 'Select your Gender'})}
		else if (this.state.cellnum===''){this.setState({error: 'Enter a Valid Cell Number'})}
		else if (this.state.occupation===''){this.setState({error: 'Select your Occupation'})}
		else if (this.state.fam_size===''){this.setState({error: 'Enter a Valid Family Size'})}
		else if (this.state.bill_amount===''){this.setState({error: 'Enter a Valid Bill Amount Number'})}
		else if (this.state.area===''){this.setState({error: 'Select your Area'})}
		else if (this.state.bill_img===''){this.setState({error: 'Upload your Electricity Bill'})}		
		else {
        ...
        <div className = "form" ref="form">
        	<div className="line">
				<div className="left double-input">
	    	  		...
	    	  		<input required type="string" placeholder="Enter CNIC/Phone Number" value={this.state.cnic} onChange={e=>{this.selectCnic(e)}}/>
				</div>
